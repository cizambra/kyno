...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("record_id", sa.String(36), nullable=False, unique=True),
    ...
    op.create_index("kyno_ix_delivery_record_time", "kyno_delivery_records", ["recorded_at"])


def downgrade() -> None:
    op.drop_table("kyno_delivery_records")
