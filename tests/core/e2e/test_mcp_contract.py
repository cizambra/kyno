...
@pytest.mark.asyncio
@pytest.mark.e2e
async def test_given_default_and_eu_when_reading_mcp_resource_then_default_mission_returns():
    from mcp.shared.memory import create_connected_server_and_client_session
...
@pytest.mark.asyncio
@pytest.mark.e2e
async def test_given_eu_direction_when_reading_mcp_tools_then_selected_content_and_detail_return():
    from mcp.shared.memory import create_connected_server_and_client_session
