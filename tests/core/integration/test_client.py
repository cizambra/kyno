...
def test_given_one_source_when_serving_two_bindings_then_there_is_no_crosstalk(control_plane):
    ...
    control_plane.apply_direction(mission="EU v1", change_note="init", constitution="eu")
    control_plane.apply_direction(mission="US v1", change_note="init", constitution="us")
    source = LocalDirectionSource(control_plane)
    eu, us = "eu", "us"

    control_plane.apply_direction(mission="EU v2", change_note="pivot", constitution="eu")
