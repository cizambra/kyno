...
def test_given_distinct_keys_when_mcp_changes_since_receives_each_key_then_selected_mission_returns(
    mcp_runner,
):
    runner, control_plane = mcp_runner
...
def test_given_named_key_updated_when_mcp_binder_bind_runs_again_then_latest_version_returns(
    mcp_runner,
):
    runner, control_plane = mcp_runner
...
def test_given_new_principles_when_local_and_mcp_changes_since_read_prior_head_then_changes_match(
    mcp_runner,
):
    runner, control_plane = mcp_runner
