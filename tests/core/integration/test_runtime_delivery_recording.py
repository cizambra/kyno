...
async def test_given_known_version_two_when_selecting_version_then_both_versions_are_recorded(
...
async def test_given_invalid_or_missing_version_when_reading_then_no_delivery_is_recorded(
