...
def test_given_omitted_key_when_local_source_changes_since_then_core_receives_none(selection):
    control_plane = Mock()
...
@pytest.mark.parametrize("selection", [{}, {"constitution_key": None}])
def test_given_omitted_key_when_mcp_source_changes_since_then_request_omits_selection(selection):
