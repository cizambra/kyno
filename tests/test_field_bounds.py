...
def test_a_mission_at_the_cap_is_accepted_and_one_over_is_refused(cp):
...
def test_a_declaration_at_the_cap_is_accepted_and_one_over_is_refused(cp):
...
def test_a_change_note_at_the_cap_is_accepted_and_one_over_is_refused(cp):
...
def test_the_principle_count_at_the_cap_is_accepted_and_one_over_is_refused(cp):
...
def test_a_principle_title_at_the_cap_is_accepted_and_one_over_is_refused(cp):
...
def test_a_principle_description_at_the_cap_is_accepted_and_one_over_is_refused(cp):
...
def test_a_constitution_name_at_the_cap_is_accepted_and_one_over_is_refused(cp):
...
def test_the_error_names_the_field_and_the_cap(cp):
...
def test_a_refused_write_leaves_an_empty_store_empty(cp):
...
def test_an_oversized_write_over_mcp_reports_the_field_not_a_stack_trace(cp):
